...
#### Description
Коспект второй части курса - Spring MVC (уроки 14-43) 
...
<!--- Урок 42 -->
<a href="/src/main/java/lesson42">
Урок 42 Валидация паттернов</a><br>
(с использованием регулярных выражений)<br>

<!--- Урок 43 -->
<a href="/src/main/java/lesson43">
Урок 43 Выпадающие списки </a><br>
(с использованием тегов select и option)